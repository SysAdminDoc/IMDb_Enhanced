[![Version](https://img.shields.io/badge/version-2.21.0-blue)](https://github.com/SysAdminDoc/IMDb_Enhanced)
...
**Because You Watched**. Optional. Marks the entries in IMDb's More like this list that you have already seen and rated, best first, with your rating on each. The candidates are IMDb's own list and the ratings are the ones stored on your device, so nothing is requested and nothing leaves the machine. It needs at least three rated Seen titles before it says anything.
