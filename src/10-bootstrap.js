(function () {
    ...
    const MESSAGES = Object.freeze({
        ...
        error_parents_guide_challenged: 'IMDb answered with a verification challenge instead of the guide',
        error_parents_guide_changed: 'The parents guide page no longer carries the ratings this reads',
        ...
        feature_listMultiSearch_detail: 'Builds a popup-safe queue of up to 20 title links on any collection page: a watchlist, a list, a chart, or your own ratings and lists.',
        feature_listMultiSearch_keywords: 'bulk, open many, tabs, batch search',
        feature_listMultiSearch_name: 'List multi-search',
        feature_listRoulette_detail: 'Adds a button to any collection page, your own ratings included, that picks one title at random and scrolls to it. It never opens anything.',
        feature_listRoulette_keywords: 'random, pick for me, shuffle, surprise',
        feature_listRoulette_name: 'Pick something to watch',
        feature_collectionExport_detail: 'Copies the rows loaded on any collection page, your own ratings included, as a CSV using IMDb column names, so it reads back into IMDb and into this extension. Only the rows on screen are included, and it says how many had no rating.',
        feature_listRuntimeSummary_detail: 'Totals how long the titles on any collection page would take to watch, your own ratings included, and says how many had no runtime listed.',
        ...
        text_open_the_full_guide: 'Open the full guide',
        text_parents_guide_empty: 'IMDb lists no severity ratings for this title.',
        text_parents_guide_refused: 'IMDb would not serve the guide to this request.',
        text_parents_guide_unavailable: 'The parents guide could not be read.',
